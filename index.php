        ...
        <div class="row">
            <?php
                ...
                while ($fila = $resultado->fetch_assoc()) {
                    ...
                    echo '       <p class="card-text"><strong>Precio:</strong> $' . number_format($fila['precio'], 2) . '</p>';
                    ...
                    if ($es_admin) {
                        ...
                        echo '         <a href="editar_paquete.php?id=' . $fila['ID_Reserva'] . '" class="btn btn-warning btn-sm">Editar</a>';
                        echo '         <a href="eliminar_paquete.php?id=' . $fila['ID_Reserva'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'¿Seguro que desea eliminar este paquete?\')">Eliminar</a>';
                        echo '       </div>';
                    }
